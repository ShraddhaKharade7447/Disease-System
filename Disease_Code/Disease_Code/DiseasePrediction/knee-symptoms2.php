...
<html lang="en">
  ...
  <?php include('link/user-topber.php'); ?> 
       ...
       <form class="form-horizontal" action="knee-symptoms3.php" method="post">
       ...
       <table id="example" cellspacing="2" width="100%">                                  
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT symptoms_tb.symptoms_id,symptoms_tb.symptoms_name from symptoms_tb where id IN (313,298,365,367,121,273)";
...
<li><button type="submit" name="submit" >SUBMIT</button></li> 
     ...
     <div class="flex-p-inside">
     <div class="flex-p-1">
     <li><a href="knee-symptoms1.php" ><button><<</button></li>
</div>
</div>
