...
<html lang="en">
  ...
  <?php include('link/user-topber.php'); ?> 
       ...
       <form class="form-horizontal" action="shoulder-symptoms2.php" method="post">
       ...
       <table id="example" cellspacing="2" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT symptoms_tb.symptoms_id,symptoms_tb.symptoms_name from symptoms_tb where id in(294,300,301,299)";
